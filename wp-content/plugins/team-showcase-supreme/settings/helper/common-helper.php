...
<br />
<div class="wpm_6310_add_media">
  <h6>Rearrange Team <span class='wpm-6310-pro'>Pro Only</span></h6>
...
<div class="wpm_6310_add_media">
  ...
  <div class="wpm_6310_add_media_body_shortcode">
    <input type="text" onclick="this.setSelectionRange(0, this.value.length)"
      value='[wpm_team_showcase id="<?php echo $id; ?>"]' />
  </div>
</div>
<br />
<div class="wpm_6310_add_media">
  ...
  <div class="wpm-6310-modal-content wpm-6310-modal-sm">
    <form action="" method="post">
      ...
      <div class="wpm-6310-modal-form-footer">
        ...
        <input type="submit" name="rearrange-list-save" class="wpm-btn-primary wpm-pull-right wpm-margin-right-10"
          id="wpm-6310-sortable-sub" value="Save" />
      </div>
    </form>
...
<div id="wpm_6310_add_new_media_modal" class="wpm-6310-modal" style="display: none">
  <div class="wpm-6310-modal-content wpm-6310-modal-md">
    <form action="" method="post">
      ...
      <div class="wpm-6310-modal-body-form">
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" class="wpm-member-table">
          ...
          <tr class="wpm-row-select" id="<?php echo $allmember['id']; ?>">
            <td width="20"><input type="checkbox" name="memid[]" value="<?php echo $allmember['id'] ?>"
                <?php if (in_array($allmember['id'], $members)) echo " checked"; ?>
                id="chk-box-<?php echo $allmember['id']; ?>" class="wpm-row-select-checkbox" /></td>
            ...
            <td>
              <?php
                  if ($allmember['iconids']) {
                    ...
                    $myIcon = $wpdb->get_results("SELECT * FROM $icon_table WHERE id in (" . $allmember['iconids'] . ") ");
                    if ($myIcon) {
      ...
      <div class="wpm-6310-modal-form-footer">
        <button type="button" name="close" class="wpm-btn-danger wpm-pull-right">Close</button>
        <input type="submit" name="team-member-save" class="wpm-btn-primary wpm-pull-right wpm-margin-right-10"
          value="Save" />
      </div>
    </form>
    <br class="wpm-6310-clear" />
...
jQuery(document).ready(function() {
  jQuery(
    '#wpm_jquery_heading_font, #wpm_jquery_designation_font, #wpm_jquery_heading_font_style1, #wpm_jquery_designation_font_style1, #wpm_jquery_heading_font_style, #wpm_jquery_designation_font_style, #wpm-front-end-load'
  ).fontselect();
});
</script>
<?php
...
<div id="wpm-6310-modal-add" class="wpm-6310-modal" style="display: none">
  <div class="wpm-6310-modal-content wpm-6310-modal-sm">
    <form action="" method="post">
      ...
      <div class="wpm-6310-modal-form-footer">
        <button type="button" name="close" class="wpm-btn-danger wpm-pull-right">Close</button>
        <input type="submit" name="item_per_row_sub" class="wpm-btn-primary wpm-pull-right wpm-margin-right-10"
          value="Update" />
      </div>
    </form>
    <br class="wpm-6310-clear" />
