          ...
          if ($members) {
            foreach ($members as $value) {
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_09 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_09 wpm_6310_team_member_info' link-id='0' team-id='{$value['id']}'";
              } else {
              ...
              <div class="wpm-6310-col-<?php echo $allStyle[0] ?>">
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_09_team_content">
                    <div class="wpm_6310_team_style_09_title"><?php echo $value['name'] ?></div>
                    <div class="wpm_6310_team_style_09_designation"><?php echo $value['designation'] ?></div>
