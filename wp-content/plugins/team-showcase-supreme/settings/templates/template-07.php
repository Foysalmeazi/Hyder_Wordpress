    ...
    <div class="wpm-plugin-setting-left">
      ...
      <style type="text/css">
        ...
        .wpm_6310_team_style_07 figcaption {
          height: <?php echo ($allStyle[18] + $allStyle[24] + $allStyle[26] + 30) ?>px;
          ...
          if ($members) {
            foreach ($members as $value) {
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_07 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
                ...
                <div<?php echo $link_type ?>>
                  ...
                  <figcaption>
                    <div class="wpm_6310_team_style_07_content">
                      <div class="wpm_6310_team_style_07_title"><?php echo $value['name'] ?></div>
                      <div class="wpm_6310_team_style_07_designation"><?php echo $value['designation'] ?></div>
                      <?php
                      if($value['iconids']) {
