               ...
               if ($members) {
                  foreach ($members as $value) {
                     if ($value['profile_details_type'] == 1) {
                        $link_type = " class='wpm_6310_team_style_03 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
                        ...
                        <div<?php echo $link_type ?>>
                           ...
                           <figcaption>
                              <div class="wpm_6310_team_style_03_caption">
                                 <div class="wpm_6310_team_style_03_designation"><?php echo $value['designation'] ?></div>
                                 <div class="wpm_6310_team_style_03_title"><?php echo $value['name'] ?></div>
                                 <?php
                                 if($value['iconids']) {
