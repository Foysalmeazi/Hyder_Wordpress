              ...
              <div class="row">
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Background Color</b> <span class="wpm-6310-pro">Pro Only</span></td>
                      <td>
                        <input type="text" name="member_bg_color" id="wpm_member_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="rgb(31, 125, 207)">
                      </td>
                    </tr>
                    <tr height="45">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr height="45">
                      <td><b>Background Color</b> <span class="wpm-6310-pro">Pro Only</span></td>
                      <td>
                        <input type="text" name="designation_bg_color" id="wpm_designation_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="rgb(31, 125, 207)">
                      </td>
                    </tr>
                    <tr height="45">
                      <td width='55%'><b>Font Weight</b><?php //wpm_pro()                    
          ...
          if ($members) {
            foreach ($members as $value) {
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_04 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='{$value['profile_url']}' target='{$value['open_new_tab']}' team-id='0'";
                ...
                <div<?php echo $link_type ?>>
                  ...
                  <figcaption>
                    <div class="wpm_6310_team_style_04_caption">
                      <div class="wpm_6310_team_style_04_designation"><?php echo $value['designation'] ?></div>
                      <div class="wpm_6310_team_style_04_title"><?php echo $value['name'] ?></div>
                      <?php
                      if($value['iconids']) {
